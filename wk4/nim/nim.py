...
class NimAI():
    ...
    def best_future_reward(self, state):
        ...
        best_future_reward = max(self.get_q_value(state, action) for action in actions) if actions else 0
    ...
    def choose_action(self, state, epsilon=True):
        ...
        if epsilon:
            ...
            actions.sort(key= lambda action: self.get_q_value(state, action), reverse=True)
