...
knowledge3 = And(
    ...
    Or(
        And(
            Implication(AKnight, AKnight), Implication(AKnave, Not(AKnight))   # A said "I am a Knight"
        ), 
        And(
            Implication(AKnight, AKnave), Implication(AKnave,Not(AKnave))       # A said "I am a Knave"
        )
    )
)
